...
class TestLoggedUser():
    ...
    def test_select_product(self, set_up_logged, data_set):
    ...
    def test_select_two_products(self, set_up_logged, data_sets=TestData.random_data_set(2)):            # для теста берется 2 рандомных товара
    ...
    def test_find_product_by_search(self, set_up_logged, data_set):
        main_page = MainPage(driver=set_up_logged)
